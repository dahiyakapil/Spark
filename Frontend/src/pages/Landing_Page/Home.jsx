...
import divimage from "../../assets/Home_Images/divimage.png"
import img1 from "../../assets/Home_Images/img1.png"
import img2 from "../../assets/Home_Images/img2.png"
import img3 from "../../assets/Home_Images/img3.png"
        ...
        <div className="linktree-page">
            <header className="header">
                <div className="logo-container">
                    ...
                    <p className='tm'><sup>TM</sup></p>
                    <span className='line'> | </span>
                    <span className="market">Marketplace</span>
                </div>
                <Link to="/signup" className="sign-in-button">Sign up free</Link>
            </header>
            ...
            <main className="main-content">
                <section className="hero-section">
                    ...
                    <div className="hero-image">
                        <img src={analytics} alt="Dashboard Preview" className="dashboard-preview" />
                    </div>
                </section>
                ...
                <section className='customer'>
                    <div className='customer-container'>
                        <div className='customer-left'>
                            <div>
                                <h2>Here's what our <span className='span-cus'>customer </span>
                                    has to says</h2>
                        ...
                        <div className='customer-right'>
                            ...
                            <div className='right-content'><p>[short description goes in here] lorem ipsum is a placeholder text to demonstrate.
                            </p></div>
                        </div>
                    </div>
                </section>
                ...
                <section className='integration-section'>
                    ...
                    <div className='int-one'>
                        ...
                        <div className='two'>
                            ...
                            <div><h4>Bandsintown</h4>
                                <p>Drive ticket sales by listing your events</p></div>
                        </div>
                        <div className='three'>
                            <div>
                                <img src={int3} alt="" />
                            ...
                            <div><h4>Bonfire</h4>
                                <p>Display and sell your custom merch</p></div>
                        </div>
                    ...
                    <div className='int-two'>
                        ...
                        <div className='five'>
                            ...
                            <div><h4>Buy Me A Gift</h4>
                                <p>Let visitors support you with a small gift</p></div>
                        </div>
                        <div className='six'>
                            <div>
                                <img src={int6} alt="" />
                    ...
                    <div className='int-three'>
                        ...
                        <div className='eight'>
                            ...
                            <div><h4>Community</h4>
                                <p>Build an SMS subscriber list</p></div>
                        </div>
                        <div className='nine'>
                            <div>
                                <img src={int9} alt="" />
                            ...
                            <div><h4>Contact Details</h4>
                                <p>Easily share downloadable contact details</p></div>
                        </div>
                    </div>
                </section>
            </main>
            ...
            <footer className="footer">
                <div className='footer-container'>
                    <div className='footer-left-buttons'>
                        ...
                        <div>  <Link to="/signup" className="sign-in-button">Sign up free</Link></div>
                    </div>
                    <div className='footer-right'>
                        <div className='footer-column'>
                            <a href="#" className="link-header">About Spark</a>
                            <a href="#">Blog</a>
                            <a href="#">Press</a>
                        ...
                        <div className="footer-column">
                            <a href="#" className="link-header">Careers</a>
                        ...
                        <div className="footer-column">
                            <a href="#" className="link-header">Terms and Conditions</a>
